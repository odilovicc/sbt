<template>
    <div class="flex gap-14 p-10">
        <div class="w-[70vw] mx-auto bg-[#1e1e1e]">
            <div class="px-10 py-4 border-b-2 border-[#393939] flex items-center">
                <Button icon="pi pi-arrow-left" label="Вернуться в список" outlined />
            ...
            <div v-for="item in items" class="px-12">
                ...
                <Button class="w-full my-10" label="Купить" outlined />
            </div>
        </div>
        <div class="w-[30vw] bg-[#1e1e1e] p-10 h-max">
...
<script>
import { data } from '@/assets/js/Broker/auctionView';
export default {
    data() {
        return {
            items: data,
...
import { ProductService } from '@/assets/js/Broker/offerToBuy';
