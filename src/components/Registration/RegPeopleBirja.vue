<template>
    <div class="wrapper-stepper mx-auto max-[640px]:w-[100vw]">
        ...
        <div class="flex justify-around">
            <button class="btn p-5 rounded-full text-2xl bg-[#75CC65] text-white border-2 border-transparent transition duration-200 hover:border-[#75CC65] hover:bg-white hover:text-[#75CC65];"
                @click="step--" :disabled="step == 1"><i class="fas fa-arrow-left"></i></button>
            <button type="submit" class="btn p-5 rounded-full text-2xl bg-[#75CC65] text-white border-2 border-transparent transition duration-200 hover:border-[#75CC65] hover:bg-white hover:text-[#75CC65]"
...
import RegStepTwo from './RegSteps/RegStepTwo.vue'
export default {
    components: {
        RegStepOne,
        RegStepTwo
